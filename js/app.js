...
//   const menu = document.getElementById("touchmenu");
//   const arrow = document.querySelector(".submenu__arrow");
//   const subarrow = document.querySelector(".submenu_subarrow");
...
//     subarrow.parentElement.classList.toggle("_active");
//   });
// }
// burgerShown();
...
$(document).ready(function () {
  $(".slick-slider").slick({
    infinite: false,
    prevArrow:
      '<button class="slider__btn slider-btn__left"><svg width="10" height="18" viewBox="0 0 10 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9.21839 1L1 9L9.21839 17"/></svg></button>',
    nextArrow:
      '<button class="slider__btn slider-btn__right"><svg width="10" height="18" viewBox="0 0 10 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0.78161 17L9 9L0.78161 1"/></svg></button>',
  });
...
$(document).ready(function () {
  const slider = $("#slider").owlCarousel({
    ...
    navText: ["<img src='img/index/slider/left-arrow.svg'>", "<img src='img/index/slider/right-arrow.svg'>"],
    responsive: {
      0: {
        items: 1,
      },
...
$(document).ready(function () {
  const slider = $("#why__slider").owlCarousel({
    loop: true,
    margin: 10,
    nav: true,
    dots: false,
...
function getPopup() {
  ...
  popup.classList.toggle("popup__shown");
}
//Modal
function getModal1() {
  var modal = document.getElementById("modal1");
  var modalClose = document.getElementById("modal-close");
  var getBG = document.getElementById("modal-wrapper");
  modal.classList.toggle("modal-window__show");
  getBG.classList.toggle("modal-wrapper");
  modalClose.classList.toggle("modal-window__show");
}
function getModal2() {
...
//   let menuArrows = document.querySelectorAll(".submenu__arrow");
...
function toggleMenu() {
  ...
  const burgerMenu = document.querySelector(".burger_dropdown");
  const burgerArrow = document.querySelectorAll(".burger__menu-arrow");
  burgerBtn.classList.toggle("active");
  burgerMenu.classList.toggle("burger_dropdown--active");
}
